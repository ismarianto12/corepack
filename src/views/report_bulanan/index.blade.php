    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                {{-- {!! PhareSpase::load_js([asset('vendor/ismarianto/dash/plugin/datatables/button/dataTables.buttons.min.js'), asset('vendor/ismarianto/dash/plugin/datatables/button/jszip.min.js'), asset('vendor/ismarianto/dash/plugin/datatables/button/pdfmake.min.js'), asset('vendor/ismarianto/dash/plugin/datatables/button/vfs_fonts.js')]) !!} --}}
                ...
                <form class="form-horizontal" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control" name="status_program" id="status_program">
                        ...
                        <label for="kode" class="col-md-2 text-center">Bulan Ke </label>
                        <div class="col-md-4">
                            <select class="form-control" name="bulan" id="bulan">
                                <option value="">Pilih data bulan</option>
                                @foreach ($month as $months => $mval)
                                    <option value="{{ $months }}">
                                        {{ $mval }}
                                    </option>
                                @endforeach
