                ...
                <div class="container">
                    <div class="card-body p-0">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2" data="tmparatmeter_id" id="tmparatmeter_id">
                                    @foreach ($tmparameter as $tmparameters)
                                        <option value="{{ $tmparameters->id }}">{{ $tmparameters->nama_prog }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
    ...
    <script>
        ...
        function del() {
            ...
            if (c.length == 0) {
                ...
                $.post("{{ route('picoveride.destroy', ':id') }}", {
                    '_method': 'DELETE',
                    'id': c
                }, function(data) {
        ...
        $(function() {
            ...
            $('#add_data').on('click', function() {
                ...
                addUrl = '{{ route('picoveride.create') }}';
