    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="p-5 bg-white rounded">
                ...
                <form id="simpan" class="needs-validation" method="POST" novalidate="">
                    @csrf
                    <div id="myTabContent" class="tab-content">
                        <div id="nasabah" role="tabpanel" aria-labelledby="nasabah-tab"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="number" name="tlp_rumah" class="form-control"
                                        placeholder="Telephone .." value="{{ $tlp_rumah }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="kota_kabupaten_domisili" class="form-control"
                                        ...
                                        value="{{ $kota_kabupaten_domisili }}" disabled>
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="catatan" class="col-md-2 text=left">Catatan
                                    Overide</label>
                                <div class="col-md-8">
                                    <textarea name="catatan" class="form-control" cols="3" rows="19"
                                        style="margin-top: 0px; margin-bottom: 0px; height: 154px;"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="biayapenutupanprog" class="col-md-2 text-left">Verifikasi </label>
                                <div class="col-md-8">
                                    <br />
                                    @if (Tmparamtertr::session('role') == 'manageroperation')
                                        <select class="form-control" name="status" id="status">
                                            @foreach (Tmparamtertr::status_overide() as $val => $ket)
                                                @php
                        ...
                        <div id="parameter" role="tabpanel" aria-labelledby="parameter-tab"
                            ...
                            @foreach ($overidemanfaat as $kes => $manfaatdata)
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                {{ $manfaatdata['jenis_hubungan']['val'] }}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                ...
                                @if (!empty($manfaatdata['catatan_pusat']['val']))
                                    <div class="alert alert-info">
                                        Catatan dari manager Business developmnet :<br />
                                        {{ $pusatusername }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <textarea class="form-control" name="catatan_pmanfaat[]"></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer text-right">
                        @if (Tmparamtertr::session('role') == 'manageroperation')
                            @if ($status_approve == 2)
                            @else
                                <button class="btn btn-primary btn-lg mr-1" type="submit"><i class="fas fa-save"></i>
                                    Simpan data</button>
                            @endif
                        ...
                        @elseif(Tmparamtertr::session('role') == 'businessdevelopment')
                            <button class="btn btn-primary btn-lg mr-1" type="submit"><i class="fas fa-save"></i>
                                Simpan data</button>
                        @endif
                        <button class="btn btn-danger btn-lg" type="reset" data-dismiss="modal">Reset</button>
                    </div>
                </form>
                <!-- End rounded tabs -->
            </div>
