                                    ...
                                    <form id="simpan" class="needs-validation" novalidate="">
                                            ...
                                            <div id="nasabah" role="tabpanel" aria-labelledby="nasabah-tab"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label for="name" class="col-md-2 text-left">Jumlah
                                                        Tanggungan</label>
                                                    <div class="col-md-4">
                                                        <select name="jumlah_tanggungan" class="form-control" required>
                                                            @for ($a = 1; $a <= 8; $a++)
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea class="form-control" name="alamat_sesuai_ktp" cols="15"
                                                            rows="12" placeholder="Alamat Sesuai KTP"></textarea style="margin-top: 0px; margin-bottom: 0px; height: 164px;">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <textarea class="form-control" name="alamat_domisili" cols="15"
                                                                        rows="12" placeholder="Alamat domisili"></textarea>
                                        ...
                                        <div class="card-footer text-right">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    <hr />
                                                    <p><input type="checkbox" name="sesuai" id="sesuai" required>
                                                        &nbsp;&nbsp;Data
                                                        yang
                                                        di isi sudah
                                                        benar
        ...
        $(function() {
            ...
            $('#simpan').on('submit', function(e) {
                ...
                if ($(this)[0].checkValidity() === false) {
                    ...
                    if ($('#sesuai').prop('checked') === false) {
                        Swal.fire('error', 'silahkan checklist form isian sudah lengkap', 'error');
                    } else {
                        Swal.fire({
                            title: 'Data yang di simpan tidak ada kesalahan .',
                            text: "Anda yakin ? ",
                            icon: 'warning',
                            showCancelButton: true,
                            confirmButtonColor: '#3085d6',
                            cancelButtonColor: '#d33',
                            confirmButtonText: 'Yakin dan lanjut'
                        }).then((result) => {
                            if (result.isConfirmed) {
                                $.ajax({
                                    ...
                                    success: function(json) {
                                        if (json.msg_overide.pmanfaat != '' || json
                                            .msg_overide
                                            .peserta !=
                                            '') {
                                            $.confirm({
